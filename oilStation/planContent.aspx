<%@ Page Title="计划内容" Language="C#" MasterPageFile="~/Master/Site.master" AutoEventWireup="true"
    CodeFile="planContent.aspx.cs" Inherits="oilStation_Default" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    <link href="../css/newscontent.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
        $(function () {
            $("a:eq(7)").css({ "color": "#E65D06" });
        });
