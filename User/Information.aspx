<%@ Page Title="" Language="C#" MasterPageFile="~/Master/UserConsole.master" AutoEventWireup="true" CodeFile="Information.aspx.cs" Inherits="User_Information" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="Head">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolder">
    <h3>
        <a href="<%=ResolveUrl("~/User/UserProjectManagement.aspx") %>">首页</a><small>></small>我的账户</h3>
    <div>
