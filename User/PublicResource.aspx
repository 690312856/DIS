<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicResource.aspx.cs" Inherits="User_PublicResource" MasterPageFile="~/Master/UserConsole.master" Title="公共资源" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <h3><a href="<%=ResolveUrl("~/User/PublicResource.aspx") %>">公共资源</a></h3>
    <div>
        <asp:Label ID="ErrorMessage" runat="server" Visible="False" Width="771px"></asp:Label>
    </div>
    <div style="float: left; margin-top: 10px; margin-left: 10px;width:500px;">
        <h4 style="width:300px">资源文件:</h4>
    <div>
        <asp:TextBox ID="searchBox" runat="server" style="float:left; margin-left:325px;margin-top:1px;height:22px;"></asp:TextBox><asp:Button ID="searchBtn" runat="server" Text="搜索" OnClick="searchBtn_Click"   Width="38" />
    </div>
    <asp:GridView ID="GridView2"
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="FileName"
                DataNavigateUrlFormatString="User/FileDetails.aspx?FileName={0}"
