<%@ Page Title="" Language="C#" MasterPageFile="~/Master/UserConsole.master" AutoEventWireup="true" CodeFile="UserProjectDoc.aspx.cs" Inherits="User_UserProjectDoc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <a href='ProjectDetail.aspx?OilProjectID=<%Response.Write(pid.ToString());%>'>
        <div style="border: 1px solid rgb(187, 187, 187); border-right: none; color: white; position: absolute; top: 64px; left: 221px; width: 100px; height: 23px; border-bottom: none; background-color: #366B6B; text-align: center;">项目概述 </div>
    </a>
    ...
    <div id="container" style="margin-top: 40px; margin-left: 5px; width: 800px; height: 437px; border-color: rgb(187, 187, 187); border-width: 1px; border-style: solid;">
        <div>
