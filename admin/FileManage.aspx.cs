...
public partial class FileManage : System.Web.UI.Page
{
    ...
    private void func()
    {
        ...
        {
            if (proName.Rows[i][0].ToString() == Request.QueryString["ProjectName"])
                break;
        }
        ...
        string str1 = "select RoleName from UPR where UserName = '" + userName + "' and ProjectName = '" + Request.QueryString["ProjectName"]
            + "'";
    ...
    protected void uploadClk_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            savePath += filename;
            string save = Server.MapPath(savePath);
