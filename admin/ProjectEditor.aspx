...
<h3><a href="<%=ResolveUrl("~/admin/Index.aspx") %>">首页</a><small>></small><a href="<%=ResolveUrl("~/admin/ProjectManage.aspx") %>">油站项目管理</a><small>></small><asp:Label ID="ti" runat="server"></asp:Label></h3>
<div>
